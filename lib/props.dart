              ...
              : CustomScrollView(
                  slivers: <Widget>[
                    ...
                    SliverGrid.count(
                        ...
                        children: product.propertiesItems
                            .map((propertiesItem) => GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                              Props(propertiesItem.product_id)),
                                    );
                                  },
                                  child: Chossing(propertiesItem.arabic_title,
                                      propertiesItem.product_id == product.id),
                                ))
                            .toList()),
                    SliverPadding(
                      padding: EdgeInsets.all(0),
